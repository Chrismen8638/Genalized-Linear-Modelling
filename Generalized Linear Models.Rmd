...
setwd("D:/STA 2402 - GLM/Trainings")
getwd()
```
```{r}
####	Binary logistic regression
...
devtools::install_github("selva86/InformationValue", dependencies = TRUE)
...
library(readxl)
anders = read_xls("D:/STA 2402 - GLM/anders.xls", sheet="anders")
View(anders)
...
ml = read_xlsx("D:/STA 2402 - GLM/hsbdemo.xlsx",sheet="hsbdemo")
View(ml)
...
library(haven)
ologit = read_dta("D:/STA 2402 - GLM/ologit.dta")
...
fish = read.csv("D:/STA 2402 - GLM/fish.csv")
View(fish)
...
hosp=read_dta("D:/STA 2402 - GLM/ztp.dta")
